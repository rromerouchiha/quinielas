...
function camposVacios(){
	var mensaje = "Debe capturar los siguientes campos, son obligatorios: ";
	var contvacios =0;
...
function camposLetras(){
  ...
  function camposNumericos(){
	var mensaje = "Los siguientes campos solo permiten Numeros Positivos: \n";
	var numero = 0;
