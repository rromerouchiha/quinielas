...
<h3>Text circle</h3>
<div class="gradient text">
<p>Added in mPDF 5.6 but not include_onced in New Features example - transparent background and Divider were new. Now also added support for font-size:auto</p>
<p class="code">
