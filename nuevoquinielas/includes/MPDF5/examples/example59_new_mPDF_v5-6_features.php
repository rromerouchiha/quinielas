...
<p>Some characters in Pashto/Sindhi/Urdu/Kurdish do not have Unicode values for the final/initial/medial forms of the characters. However, some fonts include_once glyphs for these characters "un-mapped" to Unicode (including XB Zar and XB Riyaz, which are bundled with mPDF).</p>
<p>By editing config_fonts.php and adding:</p> 
<p class="code">
	\'unAGlyphs\' => true,
</p>
<p>to appropriate fonts, this will force mPDF to use unmapped glyphs. It requires the font file to include_once a Format 2.0 POST table which references the glyphs by name as e.g. uni067C.med or uni067C.medi</p>
